...
const char * LIB_PATH_VALUE   = "D:\\WorkSpace\\VisualStudio\\repos\\ConvertTextureEncoding\\vcpkg_installed\\x64-windows\\vcpkg\\pkgs\\libiconv_x64-windows\\D\\WorkSpace\\VisualStudio\\repos\\ConvertTextureEncoding\\vcpkg_installed\\x64-windows\\x64-windows\\debug\\lib;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "D:\\WorkSpace\\VisualStudio\\repos\\ConvertTextureEncoding\\vcpkg_installed\\x64-windows\\vcpkg\\pkgs\\libiconv_x64-windows\\D\\WorkSpace\\VisualStudio\\repos\\ConvertTextureEncoding\\vcpkg_installed\\x64-windows\\x64-windows\\debug\\lib;D:\\WorkSpace\\VisualStudio\\repos\\ConvertTextureEncoding\\vcpkg_installed\\x64-windows\\vcpkg\\pkgs\\libiconv_x64-windows\\D\\WorkSpace\\VisualStudio\\repos\\ConvertTextureEncoding\\vcpkg_installed\\x64-windows\\x64-windows\\debug\\bin;";
...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("  notinst_deplibs=' /D/WorkSpace/VisualStudio/repos/ConvertTextureEncoding/vcpk", f);
  fputs ("g_installed/x64-windows/vcpkg/pkgs/libiconv_x64-windows/D/WorkSpace/VisualStudi", f);
  fputs ("o/repos/ConvertTextureEncoding/vcpkg_installed/x64-windows/x64-windows/debug/li", f);
  fputs ("b/libiconv.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    PATH=/D/WorkSpace/VisualStudio/repos/ConvertTextureEncoding/vcpkg_installed", f);
  fputs ("/x64-windows/vcpkg/pkgs/libiconv_x64-windows/D/WorkSpace/VisualStudio/repos/Con", f);
  fputs ("vertTextureEncoding/vcpkg_installed/x64-windows/x64-windows/debug/lib:/D/WorkSp", f);
  fputs ("ace/VisualStudio/repos/ConvertTextureEncoding/vcpkg_installed/x64-windows/vcpkg", f);
  fputs ("/pkgs/libiconv_x64-windows/D/WorkSpace/VisualStudio/repos/ConvertTextureEncodin", f);
  fputs ("g/vcpkg_installed/x64-windows/x64-windows/debug/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/D/WorkSpace/VisualStudio/repos/ConvertTextureEncoding/vcpkg_installe", f);
  fputs ("d/x64-windows/vcpkg/pkgs/libiconv_x64-windows/D/WorkSpace/VisualStudio/repos/Co", f);
  fputs ("nvertTextureEncoding/vcpkg_installed/x64-windows/x64-windows/debug/lib:$PATH\"\n", f);
  fputs ("\n", f);
