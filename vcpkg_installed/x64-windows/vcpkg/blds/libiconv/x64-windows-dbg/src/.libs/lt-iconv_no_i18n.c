...
const char * LIB_PATH_VALUE   = "D:\\WorkSpace\\VisualStudio\\repos\\ConvertTextureEncoding\\vcpkg_installed\\x64-windows\\vcpkg\\blds\\libiconv\\x64-windows-dbg\\lib\\.libs;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "D:\\WorkSpace\\VisualStudio\\repos\\ConvertTextureEncoding\\vcpkg_installed\\x64-windows\\vcpkg\\blds\\libiconv\\x64-windows-dbg\\lib\\.libs;D:\\WorkSpace\\VisualStudio\\repos\\ConvertTextureEncoding\\vcpkg_installed\\x64-windows\\x64-windows\\debug\\lib;D:\\WorkSpace\\VisualStudio\\repos\\ConvertTextureEncoding\\vcpkg_installed\\x64-windows\\x64-windows\\debug\\bin;";
...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("/x64-windows/vcpkg/blds/libiconv/x64-windows-dbg/lib/.libs:/D/WorkSpace/VisualS", f);
  fputs ("tudio/repos/ConvertTextureEncoding/vcpkg_installed/x64-windows/x64-windows/debu", f);
  fputs ("g/lib:/D/WorkSpace/VisualStudio/repos/ConvertTextureEncoding/vcpkg_installed/x6", f);
  fputs ("4-windows/x64-windows/debug/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/d/WorkSpace/VisualStudio/repos/ConvertTextureEncoding/vcpkg_installe", f);
  fputs ("d/x64-windows/vcpkg/blds/libiconv/x64-windows-dbg/lib/.libs:$PATH\"\n", f);
  fputs ("\n", f);
